# Forge Events & Payloads Reference
...
| File | Description |
|------|-------------|
| [jira-events.md](./events-payloads/jira-events.md) | Jira issue, comment, and workflow events |
| [bitbucket-events.md](./events-payloads/bitbucket-events.md) | Bitbucket PR and repository events |
| [confluence-events.md](./events-payloads/confluence-events.md) | Confluence page and space events |
...
| Event Name | Description |
|------------|-------------|
| `avi:bitbucket:repo:created` | New repository created |
| `avi:bitbucket:repo:updated` | Repository settings changed |
| `avi:bitbucket:repo:deleted` | Repository deleted |

### PR/Merge Events

| Event Name | Description |
|------------|-------------|
| `avi:bitbucket:pr:opened` | Pull request created |
| `avi:bitbucket:pr:updated` | PR title/description changed |
| `avi:bitbucket:pr:merged` | PR merged successfully |
| `avi:bitbucket:pr:declined` | PR declined |
